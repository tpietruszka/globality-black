...
ARG BUILD_NUM
ARG SHA1
ENV GLOBALITY_BLACK__BUILD_INFO_CONVENTION__BUILD_NUM ${BUILD_NUM}
ENV GLOBALITY_BLACK__BUILD_INFO_CONVENTION__SHA1 ${SHA1}
COPY $NAME /src/$NAME/
